            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.span_records = new ArrayList<SpanRecord>(_list56.size);
                SpanRecord _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new SpanRecord();
                  _elem57.read(iprot);
                  struct.span_records.add(_elem57);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.log_records = new ArrayList<LogRecord>(_list59.size);
                LogRecord _elem60;
                for (int _i61 = 0; _i61 < _list59.size; ++_i61)
                {
                  _elem60 = new LogRecord();
                  _elem60.read(iprot);
                  struct.log_records.add(_elem60);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.counters = new ArrayList<NamedCounter>(_list62.size);
                NamedCounter _elem63;
                for (int _i64 = 0; _i64 < _list62.size; ++_i64)
                {
                  _elem63 = new NamedCounter();
                  _elem63.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.internal_logs = new ArrayList<LogRecord>(_list65.size);
                LogRecord _elem66;
                for (int _i67 = 0; _i67 < _list65.size; ++_i67)
                {
                  _elem66 = new LogRecord();
                  _elem66.read(iprot);
                  struct.internal_logs.add(_elem66);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.span_records != null) {
        if (struct.isSetSpan_records()) {
          oprot.writeFieldBegin(SPAN_RECORDS_FIELD_DESC);
          {
            ...
            for (SpanRecord _iter68 : struct.span_records)
            {
              _iter68.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.log_records != null) {
        if (struct.isSetLog_records()) {
          oprot.writeFieldBegin(LOG_RECORDS_FIELD_DESC);
          {
            ...
            for (LogRecord _iter69 : struct.log_records)
            {
              _iter69.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.counters != null) {
        if (struct.isSetCounters()) {
          oprot.writeFieldBegin(COUNTERS_FIELD_DESC);
          {
            ...
            for (NamedCounter _iter70 : struct.counters)
            {
              _iter70.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.internal_logs != null) {
        if (struct.isSetInternal_logs()) {
          oprot.writeFieldBegin(INTERNAL_LOGS_FIELD_DESC);
          {
            ...
            for (LogRecord _iter71 : struct.internal_logs)
            {
              _iter71.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetSpan_records()) {
        {
          ...
          for (SpanRecord _iter72 : struct.span_records)
          {
            _iter72.write(oprot);
          }
        }
      ...
      if (struct.isSetLog_records()) {
        {
          ...
          for (LogRecord _iter73 : struct.log_records)
          {
            _iter73.write(oprot);
          }
        }
      ...
      if (struct.isSetCounters()) {
        {
          ...
          for (NamedCounter _iter74 : struct.counters)
          {
            _iter74.write(oprot);
          }
        }
      ...
      if (struct.isSetInternal_logs()) {
        {
          ...
          for (LogRecord _iter75 : struct.internal_logs)
          {
            _iter75.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.span_records = new ArrayList<SpanRecord>(_list76.size);
          SpanRecord _elem77;
          for (int _i78 = 0; _i78 < _list76.size; ++_i78)
          {
            _elem77 = new SpanRecord();
            _elem77.read(iprot);
            struct.span_records.add(_elem77);
          }
        }
        struct.setSpan_recordsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.log_records = new ArrayList<LogRecord>(_list79.size);
          LogRecord _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
          {
            _elem80 = new LogRecord();
            _elem80.read(iprot);
            struct.log_records.add(_elem80);
          }
        }
        struct.setLog_recordsIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.counters = new ArrayList<NamedCounter>(_list82.size);
          NamedCounter _elem83;
          for (int _i84 = 0; _i84 < _list82.size; ++_i84)
          {
            _elem83 = new NamedCounter();
            _elem83.read(iprot);
            struct.counters.add(_elem83);
          }
        }
        struct.setCountersIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.internal_logs = new ArrayList<LogRecord>(_list85.size);
          LogRecord _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new LogRecord();
            _elem86.read(iprot);
            struct.internal_logs.add(_elem86);
          }
        }
        struct.setInternal_logsIsSet(true);
      }
