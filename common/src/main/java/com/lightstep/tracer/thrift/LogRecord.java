...
public class LogRecord implements org.apache.thrift.TBase<LogRecord, LogRecord._Fields>, java.io.Serializable, Cloneable, Comparable<LogRecord> {
  ...
  public List<KeyValue> fields; // optional
  ...
  private static final _Fields optionals[] = {_Fields.TIMESTAMP_MICROS,_Fields.FIELDS,_Fields.RUNTIME_GUID,_Fields.SPAN_GUID,_Fields.STABLE_NAME,_Fields.MESSAGE,_Fields.LEVEL,_Fields.THREAD_ID,_Fields.FILENAME,_Fields.LINE_NUMBER,_Fields.STACK_FRAMES,_Fields.PAYLOAD_JSON,_Fields.ERROR_FLAG};
  ...
  public LogRecord(LogRecord other) {
    ...
    if (other.isSetFields()) {
      List<KeyValue> __this__fields = new ArrayList<KeyValue>(other.fields.size());
      for (KeyValue other_element : other.fields) {
        __this__fields.add(new KeyValue(other_element));
      }
  ...
  public java.util.Iterator<KeyValue> getFieldsIterator() {
    return (this.fields == null) ? null : this.fields.iterator();
  }

  public void addToFields(KeyValue elem) {
    if (this.fields == null) {
      this.fields = new ArrayList<KeyValue>();
    }
  ...
  public LogRecord setFields(List<KeyValue> fields) {
    this.fields = fields;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fields = new ArrayList<KeyValue>(_list8.size);
                KeyValue _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new KeyValue();
                  _elem9.read(iprot);
                  struct.fields.add(_elem9);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stack_frames = new ArrayList<String>(_list11.size);
                String _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = iprot.readString();
                  struct.stack_frames.add(_elem12);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.stack_frames != null) {
        if (struct.isSetStack_frames()) {
          oprot.writeFieldBegin(STACK_FRAMES_FIELD_DESC);
          {
            ...
            for (String _iter14 : struct.stack_frames)
            {
      ...
      if (struct.fields != null) {
        if (struct.isSetFields()) {
          oprot.writeFieldBegin(FIELDS_FIELD_DESC);
          {
            ...
            for (KeyValue _iter15 : struct.fields)
            {
              _iter15.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFields()) {
        {
          ...
          for (KeyValue _iter16 : struct.fields)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetStack_frames()) {
        {
          ...
          for (String _iter17 : struct.stack_frames)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.fields = new ArrayList<KeyValue>(_list18.size);
          KeyValue _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new KeyValue();
            _elem19.read(iprot);
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.stack_frames = new ArrayList<String>(_list21.size);
          String _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = iprot.readString();
            struct.stack_frames.add(_elem22);
          }
        }
        struct.setStack_framesIsSet(true);
      }
