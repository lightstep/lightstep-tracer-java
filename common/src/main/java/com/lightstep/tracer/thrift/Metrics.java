            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.counts = new ArrayList<MetricsSample>(_list48.size);
                MetricsSample _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new MetricsSample();
                  _elem49.read(iprot);
                  struct.counts.add(_elem49);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.gauges = new ArrayList<MetricsSample>(_list51.size);
                MetricsSample _elem52;
                for (int _i53 = 0; _i53 < _list51.size; ++_i53)
                {
                  _elem52 = new MetricsSample();
                  _elem52.read(iprot);
                  struct.gauges.add(_elem52);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.counts != null) {
        if (struct.isSetCounts()) {
          oprot.writeFieldBegin(COUNTS_FIELD_DESC);
          {
            ...
            for (MetricsSample _iter54 : struct.counts)
            {
              _iter54.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.gauges != null) {
        if (struct.isSetGauges()) {
          oprot.writeFieldBegin(GAUGES_FIELD_DESC);
          {
            ...
            for (MetricsSample _iter55 : struct.gauges)
            {
              _iter55.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetCounts()) {
        {
          ...
          for (MetricsSample _iter56 : struct.counts)
          {
            _iter56.write(oprot);
          }
        }
      ...
      if (struct.isSetGauges()) {
        {
          ...
          for (MetricsSample _iter57 : struct.gauges)
          {
            _iter57.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.counts = new ArrayList<MetricsSample>(_list58.size);
          MetricsSample _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = new MetricsSample();
            _elem59.read(iprot);
            struct.counts.add(_elem59);
          }
        }
        struct.setCountsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.gauges = new ArrayList<MetricsSample>(_list61.size);
          MetricsSample _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new MetricsSample();
            _elem62.read(iprot);
            struct.gauges.add(_elem62);
          }
        }
        struct.setGaugesIsSet(true);
      }
