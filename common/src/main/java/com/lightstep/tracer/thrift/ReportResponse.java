            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commands = new ArrayList<Command>(_list96.size);
                Command _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new Command();
                  _elem97.read(iprot);
                  struct.commands.add(_elem97);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<String>(_list99.size);
                String _elem100;
                for (int _i101 = 0; _i101 < _list99.size; ++_i101)
                {
                  _elem100 = iprot.readString();
                  struct.errors.add(_elem100);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.commands != null) {
        if (struct.isSetCommands()) {
          oprot.writeFieldBegin(COMMANDS_FIELD_DESC);
          {
            ...
            for (Command _iter102 : struct.commands)
            {
      ...
      if (struct.errors != null) {
        if (struct.isSetErrors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (String _iter103 : struct.errors)
            {
      ...
      if (struct.isSetCommands()) {
        {
          ...
          for (Command _iter104 : struct.commands)
          {
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (String _iter105 : struct.errors)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.commands = new ArrayList<Command>(_list106.size);
          Command _elem107;
          for (int _i108 = 0; _i108 < _list106.size; ++_i108)
          {
            _elem107 = new Command();
            _elem107.read(iprot);
            struct.commands.add(_elem107);
          }
        }
        struct.setCommandsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errors = new ArrayList<String>(_list109.size);
          String _elem110;
