            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commands = new ArrayList<Command>(_list64.size);
                Command _elem65;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<String>(_list67.size);
                String _elem68;
                for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                {
                  _elem68 = iprot.readString();
                  struct.errors.add(_elem68);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.commands != null) {
        if (struct.isSetCommands()) {
          oprot.writeFieldBegin(COMMANDS_FIELD_DESC);
          {
            ...
            for (Command _iter70 : struct.commands)
            {
              _iter70.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.errors != null) {
        if (struct.isSetErrors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (String _iter71 : struct.errors)
            {
      ...
      if (struct.isSetCommands()) {
        {
          ...
          for (Command _iter72 : struct.commands)
          {
            _iter72.write(oprot);
          }
        }
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (String _iter73 : struct.errors)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.commands = new ArrayList<Command>(_list74.size);
          Command _elem75;
          for (int _i76 = 0; _i76 < _list74.size; ++_i76)
          {
            _elem75 = new Command();
            _elem75.read(iprot);
            struct.commands.add(_elem75);
          }
        }
        struct.setCommandsIsSet(true);
      }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.errors = new ArrayList<String>(_list77.size);
          String _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = iprot.readString();
            struct.errors.add(_elem78);
          }
        }
        struct.setErrorsIsSet(true);
      }
