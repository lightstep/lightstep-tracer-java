...
public class ReportingService {
  ...
  public interface Iface {
    ...
    public ReportResponse Report(Auth auth, ReportRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void Report(Auth auth, ReportRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_Report(Auth auth, ReportRequest request) throws org.apache.thrift.TException
    {
    ...
    public ReportResponse recv_Report() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void Report(Auth auth, ReportRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      Report_call method_call = new Report_call(auth, request, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class Report_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public Report_call(Auth auth, ReportRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public ReportResponse getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class Report<I extends Iface> extends org.apache.thrift.ProcessFunction<I, Report_args> {
      ...
      public Report_result getResult(I iface, Report_args args) throws org.apache.thrift.TException {
        Report_result result = new Report_result();
        result.success = iface.Report(args.auth, args.request);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class Report<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, Report_args, ReportResponse> {
      public Report() {
        super("Report");
      }
      ...
      public AsyncMethodCallback<ReportResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<ReportResponse>() { 
          public void onComplete(ReportResponse o) {
            Report_result result = new Report_result();
            result.success = o;
            try {
      ...
      public void start(I iface, Report_args args, org.apache.thrift.async.AsyncMethodCallback<ReportResponse> resultHandler) throws TException {
        iface.Report(args.auth, args.request,resultHandler);
      }
    }
  ...
  public static class Report_args implements org.apache.thrift.TBase<Report_args, Report_args._Fields>, java.io.Serializable, Cloneable, Comparable<Report_args>   {
    ...
    public ReportRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ReportRequest.class)));
    ...
    public Report_args(Report_args other) {
      ...
      if (other.isSetRequest()) {
        this.request = new ReportRequest(other.request);
      }
    }
    ...
    public Report_args setAuth(Auth auth) {
      this.auth = auth;
      return this;
    }
    ...
    public Report_args setRequest(ReportRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((ReportRequest)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, Report_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new ReportRequest();
  ...
  public static class Report_result implements org.apache.thrift.TBase<Report_result, Report_result._Fields>, java.io.Serializable, Cloneable, Comparable<Report_result>   {
    ...
    public ReportResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ReportResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public Report_result(Report_result other) {
      if (other.isSetSuccess()) {
        this.success = new ReportResponse(other.success);
      }
    }
    ...
    public ReportResponse getSuccess() {
      return this.success;
    }

    public Report_result setSuccess(ReportResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((ReportResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, Report_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new ReportResponse();
