            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.join_ids = new ArrayList<TraceJoinId>(_list24.size);
                TraceJoinId _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TraceJoinId();
                  _elem25.read(iprot);
                  struct.join_ids.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<KeyValue>(_list27.size);
                KeyValue _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new KeyValue();
                  _elem28.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.log_records = new ArrayList<LogRecord>(_list30.size);
                LogRecord _elem31;
                for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                {
                  _elem31 = new LogRecord();
                  _elem31.read(iprot);
                  struct.log_records.add(_elem31);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.join_ids != null) {
        if (struct.isSetJoin_ids()) {
          oprot.writeFieldBegin(JOIN_IDS_FIELD_DESC);
          {
            ...
            for (TraceJoinId _iter33 : struct.join_ids)
            {
              _iter33.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (KeyValue _iter34 : struct.attributes)
            {
              _iter34.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.log_records != null) {
        if (struct.isSetLog_records()) {
          oprot.writeFieldBegin(LOG_RECORDS_FIELD_DESC);
          {
            ...
            for (LogRecord _iter35 : struct.log_records)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetJoin_ids()) {
        {
          ...
          for (TraceJoinId _iter36 : struct.join_ids)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (KeyValue _iter37 : struct.attributes)
          {
            _iter37.write(oprot);
          }
        }
      ...
      if (struct.isSetLog_records()) {
        {
          ...
          for (LogRecord _iter38 : struct.log_records)
          {
            _iter38.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.join_ids = new ArrayList<TraceJoinId>(_list39.size);
          TraceJoinId _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new TraceJoinId();
            _elem40.read(iprot);
            struct.join_ids.add(_elem40);
          }
        }
        struct.setJoin_idsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.attributes = new ArrayList<KeyValue>(_list42.size);
          KeyValue _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = new KeyValue();
            _elem43.read(iprot);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.log_records = new ArrayList<LogRecord>(_list45.size);
          LogRecord _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new LogRecord();
            _elem46.read(iprot);
            struct.log_records.add(_elem46);
          }
        }
        struct.setLog_recordsIsSet(true);
      }
